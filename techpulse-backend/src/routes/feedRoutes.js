...
import { getFeed, summarizeArticle, saveArticle, getSavedArticles, suggestSearch, deleteArticle, chatWithArticle } from '../controllers/feedController.js';
...
router.post('/summarize', optionalAuth, validate(summarizeSchema), summarizeArticle);
...
router.post('/chat', optionalAuth, chatWithArticle);
